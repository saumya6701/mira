const pages = {
            ...
            integration: `
                <div class="card p-6">
                    <h5 class="font-bold mb-4">Third-Party API Status</h5>
                    <div class="grid grid-cols-2 gap-4">
                        <div class="p-4 border rounded-xl flex items-center justify-between"><span>LIS Lab Sync</span><span class="status-pill bg-emerald-100 text-emerald-700 font-bold">ACTIVE</span></div>
                        <div class="p-4 border rounded-xl flex items-center justify-between"><span>Ayushman Bharat API</span><span class="status-pill bg-emerald-100 text-emerald-700 font-bold">ACTIVE</span></div>
                    </div>
                </div>
            `,
            backup: `
            ...
            `,
            settings: `<div class="card p-6"><h3 class="font-bold">ERP Core Settings</h3><p class="text-xs text-slate-500 mt-2">Manage hospital meta-data, logo, and branch configurations.</p></div>`
        };
        ...
        function showPage(pageId) {
            const titles = {
                ...
                database: 'Database & Server Management', integration: 'System Integration Hub', backup: 'Backup & Recovery Status',
                maintenance: 'Infrastructure Maintenance', help: 'Help & Documentation', settings: 'ERP Global Settings'
            };
